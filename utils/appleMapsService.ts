...
const API_BASE_URL = 'https://cribnosh.co.uk';
...
export async function getNearbyChefs(
  ...
  const response = await apiRequest<any>(`/api/customer/chefs/nearby?${params}`, 'GET');
...
export async function searchChefsByLocation(
  ...
  const response = await apiRequest<any>('/api/customer/chefs/search-by-location', 'POST', request);
...
export async function getChefDetails(chefId: string): Promise<ChefMarker> {
  const response = await apiRequest<any>(`/api/customer/chefs/${chefId}`, 'GET');
...
export async function geocodeAddress(
  ...
  return apiRequest<GeocodeResponse>('/api/apple-maps/geocode', 'POST', request);
}
...
export async function reverseGeocode(
  ...
  return apiRequest<ReverseGeocodeResponse>('/api/apple-maps/reverse-geocode', 'POST', request);
}
...
export async function searchPlaces(
  ...
  return apiRequest<PlacesSearchResponse>('/api/apple-maps/places-search', 'POST', request);
}
...
export async function getDirections(
  ...
  return apiRequest<DirectionsResponse>('/api/apple-maps/directions', 'POST', request);
}
