    ...
    try {
      ...
      return {
        ...
        session: {
          ...
          channel_name: session.session.session_id,
          title: session.session.title,
          description: session.session.description,
          chef_id: session.session.chef_id,
          meal_id: session.meal?._id,
          status: session.session.status,
          is_live: session.session.status === "live",
          viewer_count: session.session.viewerCount || 0,
          thumbnail_url: session.session.thumbnailUrl,
          started_at: session.session.actual_start_time || session.session.scheduled_start_time,
          ended_at: session.session.endedAt,
          meal: session.meal,
          chef: session.chef,
        },
      };
