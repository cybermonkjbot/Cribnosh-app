...
export default function FoodSafetyScreen() {
  ...
  const handleAllergiesSection = () => {
    Alert.alert(
      ...
      'This would open the detailed allergies management screen where you can:\n\n• Select common allergens\n• Add custom allergens\n• Set severity levels\n• Manage your allergy profile',
      [{ text: 'Manage Allergies', onPress: () => console.log('Opening allergies management') }]
    );
  };
  ...
  const handleDietaryPreferences = () => {
    Alert.alert(
      'Dietary Preferences',
      'This would open the dietary preferences screen where you can:\n\n• Set vegetarian/vegan preferences\n• Choose religious dietary requirements\n• Select health-driven options\n• Customize your diet profile',
      [{ text: 'Set Preferences', onPress: () => console.log('Opening dietary preferences') }]
    );
  };
  ...
  const handleCrossContaminationToggle = (value: boolean) => {
