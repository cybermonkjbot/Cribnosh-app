...
export default function CustomOrderDetailsScreen() {
  ...
  // Get custom order ID from route params (in real implementation)
  const customOrderId = "mock_custom_order_1"; // This would come from route params
  ...
  const customOrder = customOrderData?.data || mockCustomOrder;
