      ...
      <div ref={ref} className="relative max-w-7xl mx-auto">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white/80  backdrop-blur-sm flex items-center justify-center border border-white/20 shadow-lg transition-all duration-300 group-hover:scale-110">
                <div className="h-4 w-4 rounded-full bg-[#ff3b30]  transition-all duration-300 group-hover:scale-110" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[#ff3b30] via-[#ff5e54] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
