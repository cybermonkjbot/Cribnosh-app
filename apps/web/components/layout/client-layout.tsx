...
export function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const isFoodCreatorRoute = pathname?.startsWith('/food-creator') ?? false;
  ...
  // Hide footer on pages with floating bottom menu or chef/food-creator routes
  const shouldShowFooter = !isFoodOrderingRoute && !isChefRoute && !isFoodCreatorRoute;
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="light" enableSystem>
      ...
      <div>
        ...
        >
          {/* Hide header on mobile for waitlist page, and always for admin/staff/chef/food-creator/apps */}
          {!(isAdminRoute || isStaffRoute || isChefRoute || isFoodCreatorRoute || isApplicationPage || (isWaitlistPage && isMobile)) && (
            <>
          ...
          {shouldShowFooter && !(isAdminRoute || isStaffRoute || isChefRoute || isFoodCreatorRoute || isTryItPage || isApplicationPage || (isWaitlistPage && isMobile)) && <Footer className="mt-auto h-[var(--footer-height)]" />}
