...
async function handlePOST(request: NextRequest) {
  try {
    ...
    if (payload.role === 'chef' && validOrder.chef_id !== payload.user_id) {
    ...
    console.log(`Order ${orderId} confirmed by ${payload.user_id} (${payload.role})`);
