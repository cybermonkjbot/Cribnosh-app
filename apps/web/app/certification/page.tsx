...
import { Award, ShieldCheck, Home, ChefHat, ClipboardCheck, ArrowRight } from 'lucide-react';
...
const certificationSteps = [
  {
    ...
    description: "Initial assessment of kitchen facilities, hygiene standards, and safety measures.",
    details: [
      "Equipment quality check",
      "Storage facilities evaluation",
  ...
  },
  {
    ...
    description: "Comprehensive food safety certification process and documentation.",
    details: [
  ...
  {
    icon: <ClipboardCheck className="w-6 h-6 text-[#ff3b30]" />,
    title: "Quality Compliance",
    description: "Ongoing monitoring and quality assurance processes.",
    details: [
  ...
  {
    icon: <Award className="w-6 h-6 text-[#ff3b30]" />,
    title: "Final Certification",
    description: "Official certification and continuous monitoring program.",
    details: [
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 sm:mb-12">
              <div>
                ...
                >
                  Understanding our rigorous certification standards and process
                </motion.p>
              </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-4 sm:p-8 max-w-2xl">
                ...
                <p className="text-white/90 text-sm sm:text-lg leading-relaxed drop-shadow-lg">
                  Every Cribnosh kitchen undergoes a thorough certification process to ensure 
                  the highest standards of food safety, hygiene, and quality. Our certification 
                  is recognized by UK food safety authorities.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <span className="font-medium">Learn About UK Food Compliance</span>
