                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc pl-5 space-y-3 text-gray-600">
                                        <li>
                                            <strong className="text-gray-900">FoodCreators:</strong> Independent individuals and small businesses who prepare meals. They are the heart of our platform, and we maintain strict oversight of their operations.
                                        </li>
                                        <li>
