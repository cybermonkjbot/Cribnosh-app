...
import { useGetCommunityGuidelinesQuery } from '../store/driverApi';

export default function CommunityGuidelinesScreen() {
  const router = useRouter();
  // Fetch community guidelines using RTK Query
  const { data: communityGuidelinesResponse, isLoading } = useGetCommunityGuidelinesQuery();
  const communityGuidelines = communityGuidelinesResponse?.data || null;
          ...
          <>
            ...
            <View style={styles.lastUpdatedContainer}>
              <ThemedText style={styles.lastUpdatedText}>
                Last Updated: {new Date(communityGuidelines.lastUpdated).toLocaleDateString()}
              </ThemedText>
            </View>

            {/* Content */}
            <View style={styles.contentContainer}>
              <ThemedText style={styles.contentTitle}>{communityGuidelines.title}</ThemedText>
              <ThemedText style={styles.contentBody}>{communityGuidelines.content}</ThemedText>
            </View>
          </>
        ) : (
          <View style={styles.loadingContainer}>
