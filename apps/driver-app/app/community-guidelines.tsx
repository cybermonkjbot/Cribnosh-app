          ...
          <>
            ...
            <View style={styles.lastUpdatedContainer}>
              <ThemedText style={styles.lastUpdatedText}>
                Last Updated: {communityGuidelines.lastUpdated}
              </ThemedText>
            </View>

            {/* Content */}
            {communityGuidelines.content.map((section: { section: string; title: string; body: string }, index: number) => (
            ...
            {/* FAQs */}
            {communityGuidelines.faqs && communityGuidelines.faqs.length > 0 && (
              <FAQAccordion faqs={communityGuidelines.faqs} />
            )}
          </>
        )}
