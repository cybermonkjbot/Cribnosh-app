...
export class LocationService {
    ...
    try {
      ...
      if (status !== 'granted') {
        Alert.alert(
          ...
          'This app needs location access to track deliveries and update your location. Please enable location permissions in your device settings.',
          [
  ...
  public async getCurrentLocationWithAddress(config?: LocationServiceConfig): Promise<LocationWithAddress | null> {
    try {
      ...
      logger.error('Error getting location with address:', error);
      return null;
    }
  }
  ...
  public async startLocationWatching(
    ...
    try {
      ...
      logger.error('Error starting location watching:', error);
      return false;
    }
  }
