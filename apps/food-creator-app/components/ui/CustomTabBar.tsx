...
import { CustomFoodCreatorDashboardIcon } from './CustomFoodCreatorDashboardIcon';
import { CustomFoodCreatorOrdersIcon } from './CustomFoodCreatorOrdersIcon';
import { CustomFoodCreatorProfileIcon } from './CustomFoodCreatorProfileIcon';
            ...
            {state.routes
              ...
              .map((route, filteredIndex) => {
                ...
                const renderIcon = () => {
                  if (route.name === 'index') {
                    return (
                      <CustomFoodCreatorDashboardIcon 
                        size={48} 
