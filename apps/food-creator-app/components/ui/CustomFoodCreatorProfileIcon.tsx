...
interface CustomFoodCreatorProfileIconProps {
  size?: number;
  color?: string;
}

export function CustomFoodCreatorProfileIcon({ size = 36, color = '#0B9E58' }: CustomFoodCreatorProfileIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 31 36" fill="none">
      <Path 
