...
import { KitchenSetupSheet } from './KitchenSetupSheet';
    ...
    try {
      ...
      Alert.alert(
        ...
        [
          {
            text: 'Retry',
            onPress: () => handleProfileImageSelected(imageUri),
          },
          {
            text: 'Cancel',
            style: 'cancel',
            onPress: () => {
              // Revert to previous picture from backend
              setSelectedProfileImage(undefined);
            },
          },
        ]
        ...
        >
          <View style={styles.headerSection}>
            <View style={styles.avatarContainer}>
              <View style={[styles.skeletonAvatar, { width: 80, height: 80 }]} />
            </View>
