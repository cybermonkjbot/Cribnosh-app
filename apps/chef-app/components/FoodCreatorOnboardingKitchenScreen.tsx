...
interface FoodCreatorOnboardingKitchenScreenProps {
...
export const FoodCreatorOnboardingKitchenScreen: React.FC<FoodCreatorOnboardingKitchenScreenProps> = ({
  onNext,
  onSkip,
  onBack,
  backgroundImage,
...
export default FoodCreatorOnboardingKitchenScreen;
