...
import { setToastErrorFunction as setNetworkErrorToastFunction } from '../utils/networkErrorHandler';
import { setToastErrorFunction as setAuthErrorToastFunction } from '../utils/authErrorHandler';
...
export const ToastProvider: React.FC<ToastProviderProps> = ({ children }) => {
  ...
  // Initialize error handlers with toast function
  useEffect(() => {
    setNetworkErrorToastFunction(showError);
    setAuthErrorToastFunction(showError);
  }, [showError]);
